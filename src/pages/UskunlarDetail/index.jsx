...
export default function UskunaDetailPage() {
  ...
  const API_TABS = {
    "UCH-07B": [{ key: "eaf", label: "🔥 Elektrda Eritish Pechi" }],
    "UCH-07D": [{ key: "lrf", label: "⚗️ Kovsh Tozalash Pechi" }],
    "UCH-07C": [
      { key: "tsc", label: "🧊 Qolibga Quyish" },
  ...
  return (
    <Box sx={{ minHeight: "100%", bgcolor: "background.default" }}>
      ...
      >
        {tab === TAB_SXEMA && <UskunaImageView uskuna={uskuna} />}
