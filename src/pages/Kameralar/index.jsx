...
//         backgroundImage:
//           "repeating-linear-gradient(45deg, transparent, transparent 2px, rgba(0,212,255,0.015) 2px, rgba(0,212,255,0.015) 4px)",
//       }}
//     >
//       {/* SCENE */}
//       <Box
...
//           gap: 1,
//           opacity: cam.holat === "signal_yoq" ? 0.3 : 0.7,
//         }}
//       >
...
//             height: 6,
//             borderRadius: "50%",
//             background: camColors[cam.holat] || "#374151",
//             animation: isLive ? "blink 0.8s step-end infinite" : "none",
...
//       {isLive && (
//         <img
//           src={`http://localhost:8007/camera/${cam.channel}`}
//           style={{
//             width: "100%",
//             height: "100%",
//             objectFit: "cover",
      ...
      <Paper>
        ...
        <Box sx={{ p: 2 }}>
          <Grid container spacing={3}>
            {filtered.map((cam) => (
              <Grid item xs={12} sm={6} md={2} key={cam.id}>
