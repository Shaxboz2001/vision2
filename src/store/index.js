...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    setSelectedSex: (state, action) => { state.selectedSex = action.payload },
    setSelectedUchastka: (state, action) => { state.selectedUchastka = action.payload },
  }
})
...
const ogohlantirishSlice = createSlice({
  ...
  reducers: {
    ...
    clearFilter: (state) => { state.filter = { daraja: '', holat: '' } },
...
const datchikSlice = createSlice({
  ...
  reducers: {
    setDatchikFilter: (state, action) => { state.filter = { ...state.filter, ...action.payload } },
...
const uskunaSlice = createSlice({
  ...
  reducers: {
    setUskunaFilter: (state, action) => { state.filter = { ...state.filter, ...action.payload } },
    setUskunaSelected: (state, action) => { state.selectedId = action.payload },
  }
})

export const { toggleSidebar, setSidebarOpen, setSelectedSex, setSelectedUchastka } = uiSlice.actions
export const { setFilter, clearFilter, setSelectedId } = ogohlantirishSlice.actions
